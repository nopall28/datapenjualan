                  ...
                  <div class="col-lg-12 main-chart">
						...
						<table class="table table-striped">
							<form action="fungsi/edit/edit.php?barang=edit" method="POST">
								...
								<tr>
									<td>Harga Beli</td>
									<td><input type="text" class="form-control" value="<?php echo $hasil['harga_beli'];?>" name="beli" onkeypress="return hanyaAngka(event);"></td>
								...
								<tr>
									<td>Harga Jual</td>
									<td><input type="text" class="form-control" value="<?php echo $hasil['harga_jual'];?>" name="jual" onkeypress="return hanyaAngka(event);"></td>
									<script type="text/javascript">
										function hanyaAngka(evt){
										var charCode = (evt.which) ? evt.which : event.keyCode
										if (charCode > 31 && (charCode < 48 || charCode >57)) {
