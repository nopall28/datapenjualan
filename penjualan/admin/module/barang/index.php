								...
								<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												<td>Harga Beli</td>
												<td><input type="text" placeholder="Harga Beli" required class="form-control" name="beli" onkeypress="return hanyaAngka(event);"></td>
											...
											<tr>
												<td>Harga Jual</td>
												<td><input type="text" placeholder="Harga Jual" required class="form-control"  name="jual" onkeypress="return hanyaAngka(event);"></td>
												<script type="text/javascript">
													function hanyaAngka(evt){
														var charCode = (evt.which) ? evt.which : event.keyCode
														if (charCode > 31 && (charCode < 48 || charCode >57)) {
											...
											<tr>
												<td>Stok</td>
												<td><input type="number" required Placeholder="Stok" class="form-control"  name="stok" onkeypress="return hanyaAngka(event);"></td>
												<script type="text/javascript">
													function hanyaAngka(evt){
														var charCode = (evt.which) ? evt.which : event.keyCode
														if (charCode > 31 && (charCode < 48 || charCode >57)) {
