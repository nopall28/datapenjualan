                  ...
                  <div class="col-lg-12 main-chart">
						...
						<div class="modal-view">
							<table class="table table-bordered" id="example1">
								...
								<tbody>
									<?php 
										$pengeluaran = mysqli_query($koneksi, "SELECT * FROM data_pengeluaran");
										$totalApalah = 0;
										foreach( $pengeluaran as $data ){
										$totalApalah += $data["jumlah_pengeluaran"];
									}
										$no=1; 
										if(!empty($_GET['cari'])){
								...
								<tfoot>
									<tr>
										...
										<th style="background:#0bb365;color:#fff;">Keuntungan Bersih</th>
										<th style="background:#0bb365;color:#fff;">
											Rp.<?php echo number_format($bayar - $modal - $totalApalah);?>,-</th>
									</tr>
								</tfoot>
							</table>
						</div>
