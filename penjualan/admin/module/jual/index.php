									...
									<div id="kasirnya">
										<table class="table table-stripped">
											...
											<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
												...
												<tr>
													<td>Total Semua  </td>
													<td><input type="text" class="form-control" id="nopal" name="total" value="<?php echo $total_bayar;?>"></td>
												
													<td>Bayar  </td>
													<td><input type="text" class="form-control" id="nopal" name="bayar" value="<?php echo $bayar;?>"></td>
											...
											<tr>
												<td>Kembali</td>
												<td><input type="text" class="form-control" id="nopal" value="<?php echo $hitung;?>"></td>
												<td></td>
												<td>
